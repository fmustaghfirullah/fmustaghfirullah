...
* **Tugas Akhir:** Mengembangkan sistem pengawasan ujian berbasis *Client-Side Monitoring* menggunakan metode *Rule-Based* dan *Random Forest*.
* **AI Data Annotation:** Bekerja sebagai AI Data Annotator independen.
* **Computer Vision:** Membangun proyek menggunakan YOLOv8 untuk deteksi dan penghitungan objek melalui streaming CCTV.
* **Cybersecurity:** Aktif melakukan Web Penetration Testing dan berpartisipasi dalam program Bug Bounty untuk mencari kerentanan keamanan web.

### 🛠️ Tech Stack & Keahlian
* **Bahasa Pemrograman & Framework:** Python, JavaScript, Node.js, Dart, Flutter
* **Cybersecurity:** Vulnerability Assessment, Authentication Bypass, API Security, Endpoint Security
* **Artificial Intelligence:** Computer Vision YOLOv8, Generative AI, integrasi Gemini API
* **Cloud Computing:** Google Cloud Platform, GKE, BigQuery ML, pemegang lebih dari 20 skill badges GCP
...
## 🌐 Socials:
[![Instagram](https://img.shields.io/badge/Instagram-%23E4405F.svg?logo=Instagram&logoColor=white)](https://instagram.com/findinghopein3a.m) [![LinkedIn](https://img.shields.io/badge/LinkedIn-%230077B5.svg?logo=linkedin&logoColor=white)](https://linkedin.com/in/faisal-mustaghfirullah) 
...
# 📊 GitHub Stats:
![](https://github-readme-stats.shion.dev/api?username=fmustaghfirullah&theme=dark&hide_border=false&include_all_commits=true&count_private=true)<br/>
![](https://streak-stats.demolab.com/?user=fmustaghfirullah&theme=dark&hide_border=false)<br/>
![](https://github-readme-stats.shion.dev/api/top-langs/?username=fmustaghfirullah&theme=dark&hide_border=false&include_all_commits=true&count_private=true&layout=compact)
